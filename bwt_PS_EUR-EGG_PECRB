libname gwas "LOCATION_OF_EGG_EUR_DATA";
libname pecrb "LOCATION_OF_PECRB_DATA";
libname ps "LOCATION_OF_ORIGINAL_DATASETS";
libname pscopy "LOCATION_OF_COPIES_OF_DATASETS";
libname impgric "LOCATION_OF_IMPUTED_GENOTYPES";
